...
exports.app.get('/', (req, res) => {
    res.send('Welcome!!! Type image name and image width, height in url to get resized image (default width, height is 200px)');
});
exports.app.use('/api/image', image_1.imageRouters);
server.listen(port, () => __awaiter(void 0, void 0, void 0, function* () {
    console.log(`[server]: Server is running on port ${port}, current time: `, new Date());
}));
